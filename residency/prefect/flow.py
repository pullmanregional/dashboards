...
PREFECT_FLOW_NAME = "prw-datamart-residency"
...
PRH_RESIDENCY_VENV_NAME = os.environ.get("PRH_RESIDENCY_VENV_NAME", "")
PRH_RESIDENCY_CLOUDFLARE_R2_BUCKET = os.environ.get(
    "PRH_RESIDENCY_CLOUDFLARE_R2_BUCKET"
)
PRH_RESIDENCY_DATA_KEY = (
    os.environ.get("PRH_RESIDENCY_DATA_KEY")
...
def prw_datamart_residency():
    ...
    with ShellOperation(
        ...
        env={
            ...
            "PIPENV_CUSTOM_VENV_NAME": PRH_RESIDENCY_VENV_NAME,
        },
        stream_output=True,
    ) as op:
        proc = op.trigger()
